  ...
  module OrderDecorator
    ...
    def pdf_file
      ActiveSupport::Deprecation.warn(
        'This API has changed: Please use order.invoice.pdf instead'
      )
      invoice.pdf
    end
    ...
    def pdf_filename
      ActiveSupport::Deprecation.warn(
        'This API has changed: Please use order.invoice.file_name instead'
      )
      invoice.file_name
    end
    ...
    def pdf_file_path
      ActiveSupport::Deprecation.warn(
        'This API has changed: Please use order.invoice.pdf_file_path instead'
      )
